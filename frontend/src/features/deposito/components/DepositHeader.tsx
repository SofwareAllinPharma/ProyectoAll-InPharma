...
export default function DepositHeader({ title, subtitle, onCreate, hideCreateButton, backLink, backText }: Props) {
  return (
    <div className="mb-6 flex flex-col items-start justify-between gap-3 md:flex-row md:items-center">
      <div>
        {backLink && (
          <Link to={backLink} className="text-[#7C6A55] hover:underline text-sm mb-1 block">
            {backText || '← Volver'}
          </Link>
        )}
