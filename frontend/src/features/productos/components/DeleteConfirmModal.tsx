...
export const DeleteConfirmModal: React.FC<Props> = ({ isOpen, producto, onConfirm, onCancel, isLoading = false }) => {
  if (!isOpen || !producto) return null;

  const description = (
    <div className="space-y-4">
      <p className="text-gray-700">Se eliminará el producto <strong className="text-gray-900">"{producto.nombreComercial}"</strong>?</p>
