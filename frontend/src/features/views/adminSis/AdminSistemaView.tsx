    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <p className="text-sm text-gray-600">
              Materias primas disponibles en el sistema
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <p className="text-sm text-gray-600">
              Fórmulas nutricionales desarrolladas
            </p>
          </div>
        </div>
        {/* Card de Productos */}
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 hover:shadow-xl transition-shadow duration-300">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <p className="text-sm text-gray-600">
              Productos comerciales elaborados
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">
              {loading
                ? "..."
                : Math.round((formulasCount / Math.max(insumosCount, 1)) * 100)}
              %
            </div>
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">
              {loading
                ? "..."
                : Math.round(
                    (productosCount / Math.max(formulasCount, 1)) * 100
                  )}
              %
            </div>
            <div className="text-sm text-gray-600">
              Ratio Productos/Fórmulas
            </div>
          </div>
          <div className="text-center">
