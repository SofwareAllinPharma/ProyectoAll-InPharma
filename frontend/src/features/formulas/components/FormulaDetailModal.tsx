...
const FormulaDetailModal: React.FC<Props> = ({ isOpen, formula, onClose }) => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 gap-1">
      ...
      <div className="flex gap-3 px-4 py-3 justify-center sm:justify-end">
        <button
          type="button"
          onClick={onClose}
          className="px-4 py-2 rounded-lg bg-[#5d5448] text-white hover:bg-[#5d5448]/90 transition-colors"
        >
          Cerrar
        </button>
      </div>
