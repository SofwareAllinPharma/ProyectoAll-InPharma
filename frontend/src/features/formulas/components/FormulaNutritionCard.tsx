...
const FormulaNutritionCard: React.FC<{ title: string; subtitle?: string; colorClass?: 'green' | 'orange' | 'purple'; rows: Row[] }> = ({ title, subtitle, colorClass = 'green', rows }) => {
...
export default FormulaNutritionCard;
