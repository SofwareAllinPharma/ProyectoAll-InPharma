...
const depositos_service_1 = require("../services/depositos.service");
const depositosService = new depositos_service_1.DepositosService();
class DepositosController {
    ...
    async create(req, res) {
        try {
            ...
            const isUniqueNombre = (error?.code === "P2002" &&
